...
$ownerCommand = @(
    ...
    '-PdfPath', (Quote-PsString $PdfPath),
...
$overlayCommand = @(
    ...
    '-SourcePdfPath', (Quote-PsString $PdfPath),
    '-PlacementSignalPath', (Quote-PsString $signalPath)
) -join ' '
...
Write-Host '  2. Auf Windows die gewählte PDF-Karte nehmen.'
Write-Host '  3. An den Glasrand ziehen und loslassen.'
Write-Host '  4. Wenn du sie 10 Sekunden nicht wieder nimmst, erscheint der Frame auf macOS.'
