...
- Die Premium-Portal-Iteration ersetzt falsche Eigenrotation des digitalen Dings durch `PortalEdgeSqueeze`: die tunnelnahe Kante und ihre Ecken werden lokal zusammengezogen, waehrend der Schatten als `ShadowTunnelSuction` mit in den Tunnel gezogen wird.
